...
Ce projet utilise **Backend Laravel 11**, **Frontend React 18** et **PostgreSQL**. Tout est orchestré avec **Docker** pour que nous ayons tous exactement le même environnement.
